...
class StockPrediction(models.Model):
    ...
    CURRENCY_SYMBOLS = {
        # Americas
        'USD': '$', 'CAD': 'C$', 'MXN': 'MX$', 'BRL': 'R$', 'ARS': 'ARS$',
        'CLP': 'CLP$', 'COP': 'COP$', 'PEN': 'S/', 'UYU': '$U', 'BOB': 'Bs.',
        'PYG': '₲', 'VES': 'Bs.S', 'GTQ': 'Q', 'CRC': '₡', 'DOP': 'RD$',
        'JMD': 'J$', 'TTD': 'TT$', 'BBD': 'Bds$',
        # Europe
        'EUR': '€', 'GBP': '£', 'CHF': 'Fr', 'NOK': 'kr', 'SEK': 'kr',
        'DKK': 'kr', 'PLN': 'zł', 'CZK': 'Kč', 'HUF': 'Ft', 'RON': 'lei',
        'BGN': 'лв', 'HRK': 'kn', 'RSD': 'din', 'TRY': '₺', 'RUB': '₽',
        'UAH': '₴', 'GEL': '₾', 'AMD': '֏', 'AZN': '₼', 'ISK': 'kr',
        # Asia-Pacific
        'INR': '₹', 'JPY': '¥', 'CNY': '¥', 'HKD': 'HK$', 'SGD': 'S$',
        'AUD': 'A$', 'NZD': 'NZ$', 'KRW': '₩', 'TWD': 'NT$', 'THB': '฿',
        'MYR': 'RM', 'IDR': 'Rp', 'PHP': '₱', 'VND': '₫', 'PKR': '₨',
        'BDT': '৳', 'LKR': 'Rs', 'NPR': 'Rs', 'MMK': 'K', 'KHR': '៛',
        'LAK': '₭', 'MNT': '₮', 'KZT': '₸', 'UZS': "so'm", 'AFN': '؋',
        # Middle East
        'AED': 'د.إ', 'SAR': '﷼', 'QAR': '﷼', 'KWD': 'د.ك', 'BHD': '.د.ب',
        'OMR': '﷼', 'JOD': 'JD', 'ILS': '₪', 'IRR': '﷼', 'IQD': 'ع.د', 'LBP': 'ل.ل',
        # Africa
        'ZAR': 'R', 'NGN': '₦', 'KES': 'KSh', 'GHS': '₵', 'EGP': '£',
        'MAD': 'د.م.', 'DZD': 'دج', 'TND': 'د.ت', 'ETB': 'Br', 'TZS': 'TSh',
        'UGX': 'USh', 'XOF': 'CFA', 'XAF': 'FCFA', 'MUR': '₨', 'ZMW': 'ZK', 'BWP': 'P',
        # Crypto
        'BTC': '₿', 'ETH': 'Ξ', 'USDT': '₮', 'BNB': 'BNB', 'SOL': 'SOL',
        'XRP': 'XRP', 'USDC': 'USDC', 'ADA': 'ADA', 'DOGE': 'Ð', 'MATIC': 'MATIC',
    }
