...
urlpatterns = [
    ...
    path('stocks/<str:post_id>/live-price/', views.fetch_live_stock_price, name='fetch_live_stock_price'),
    ...
    path('dismiss-debate/<str:debate_id>/', views.dismiss_debate, name='dismiss_debate'),
    ...
    path('debates/<str:debate_id>/typing/', views.debate_typing, name='debate_typing'),
